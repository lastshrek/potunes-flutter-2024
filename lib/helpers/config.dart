/*
 * @Author       : lastshrek
 * @Date         : 2024-05-18 22:31:48
 * @LastEditors  : lastshrek
 * @LastEditTime : 2024-05-18 22:31:49
 * @FilePath     : /helpers/config.dart
 * @Description  : config
...
class MyTheme with ChangeNotifier {
  ...
  // bool _isDark = brightness == Brightness.dark;
  bool _isDark = Hive.box('settings').get('darkMode', defaultValue: true) as bool;

  bool _useSystemTheme = Hive.box('settings').get('useSystemTheme', defaultValue: true) as bool;
